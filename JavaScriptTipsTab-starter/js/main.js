$(function () {
    ...
    // Generate a random number between O and max 
    function getRandomNumber(max) {
        return Math.floor(Math.random() * Math.floor(max));
    }

    //console.log(getRandomNumber(tipLimit));

    // Generate a tip:
    // 1. Get random number from getRandomNumber()
    ...
    $(".tip-button").click(function () {
        $(".js-tip").html(tipsList[getRandomNumber(tipsList.length)]);
